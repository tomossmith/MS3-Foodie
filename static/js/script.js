...
$(document).ready(function(){
  ...
  var ingredientFieldHTML = '<div><input type="text" name="field_name[]" value=""/><a href="javascript:void(0);" class="ingredient_remove_button"><i class="fas fa-trash-alt"></i></a></div>'; //New input field html 
...
$(document).ready(function(){
  ...
  var instructionFieldHTML = '<div><input type="text" name="field_name[]" value=""/><a href="javascript:void(0);" class="instruction_remove_button"><i class="fas fa-trash-alt"></i></a></div>'; //New input field html 
  var x = 1; //Initial field counter is 1
